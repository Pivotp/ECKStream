...
def Event_triggered(epsilons, e):
    file_path = 'Power.csv'
...
def main():
    ep = 1
    min_e, max_e, step_e = 0.1, 0.9, 0.1

    with open("results_single_epsilon.txt", "a") as f:
        ...
        for e in np.arange(min_e, max_e, step_e):
            ...
            for run in range(num_runs):
                ...
                perturb_data, Threshold = Event_triggered(ep, e)
            ...
            f.write("mean_distance"f"{e}\t{avg_mean_distance}\n")
            f.write("mean_mae"f"{e}\t{avg_mae_error}\n")
            f.flush()
